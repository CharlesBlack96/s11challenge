...
class API(object):
    ...
    def _send(self, endpoint, method='GET', **kwargs):
        ...
        try:
            res['meta']['pages'] = math.ceil(res['meta']['found'] / res['meta']
['limit'])
        except:
            pass
...
class OpenAQ(API):
    ...
    def cities(self, **kwargs):
        ...
        :param order_by: order by one or more fields (ex. order_by=['country', 
'locations']). Default value is 'country'
        :param sort: define the sort order for one or more fields (ex. sort='desc')
        :return: dictionary containing the *city*, *country*, *count*, and number 
of *locations*
    ...
    def countries(self, **kwargs):
        ...
        :param order_by: order by one or more fields (ex. order_by=['cities', 
'locations']). Default value is 'country'
        :param sort: define the sort order for one or more fields (ex. sort='desc')
        :param limit: change the number of results returned. Max is 10000. Default 
is 100.
        ...
        :type df: bool
        :type index: string
        :return: dictionary containing the *code*, *name*, *count*, *cities*, and 
number of *locations*.
        :Example:
        >>> import openaq
        >>> api = openaq.OpenAQ()
    ...
    def latest(self, **kwargs):
        ...
        :param coordinates: center point (`lat`, `long`) used to get measurements 
within a
                                certain area. (Ex: coordinates=40.23,34.17)
        :param radius: radius (in meters) used to get measurements. Must be used 
with coordinates.
...
is 100.
        ...
        :type df: bool
        :type index: string
        :return: dictionary containing the *location*, *country*, *city*, and 
number of *measurements*
    ...
    def locations(self, **kwargs):
        ...
        :param city: Limit results by one or more cities. Defaults to ``None``. Can
define as a single city
                        (ex. city='Delhi'), a list of cities (ex. city=['Delhi', 
'Mumbai']), or as a tuple
                        (ex. city=('Delhi', 'Mumbai')).
        :param country: Limit results by one or more countries. Should be a 2-digit
                        ISO country code as a string, a list, or a tuple. See 
`city` for details.
...
within a
                                certain area. (Ex: coordinates=40.23,34.17)
        :param nearest: get the X nearest number of locations to `coordinates`. 
Must be used
                        with coordinates. Wins over `radius` if both are present. 
Will add the
...
with coordinates.
                        Default value is 2500.
        :param order_by: order by one or more fields (ex. order_by=['country', 
'count']). Default value is 'location'
        :param sort: define the sort order for one or more fields (ex. sort='desc')
        :param limit: change the number of results returned. Max is 10000. Default 
is 100.
        :param page: paginate through the results.
        ...
        :type df: bool
        :type index: string
        :return: a dictionary containing the *location*, *country*, *city*, 
*count*, *distance*,
                    *sourceName*, *sourceNames*, *firstUpdated*, *lastUpdated*, 
...
with `coordinates`.
                        Default value is 2500.
        :param value_from: Show results above a value threshold. Must be used with 
`parameter`.
        :param value_to: Show results below a value threshold. Must be used with 
`parameter`.
        :param date_from: Show results after a certain date. Format should be ``Y-
M-D``.
        :param date_to: Show results before a certain date. Format should be ``Y-M-
D``.
        :param sort: The sort order (``asc`` or ``desc``). Must be used with 
`order_by`.
        :param order_by: Field to sort by. Must be used with **sort**.
        :param include_fields: Include additional fields in the output. Allowed 
values are: *attribution*,
                            *averagingPeriod*, and *sourceName*.
        :param limit: Change the number of results returned. Max is 10000 and 
default is 100.
        :param page: Paginate through the results
        :type city: string
        :type country: string
    ...
    def fetches(self, **kwargs):
        """Provides data about individual fetch operations that are used to 
populate
        data in the platform.
        :param order_by: order by one or more fields (ex. order_by=['timeEnded', 
'count']). Default value is 'country'
        :param sort: define the sort order for one or more fields (ex. sort='desc')
        :param limit: change the number of results returned. Max is 10000. Default 
is 100.
        :param page: paginate through the results. Default is 1.
        ...
        :type limit: int
        :type page: int
        :return: dictionary containing the *timeStarted*, *timeEnded*, *count*, and
*results*
        :Example:
        >>> import openaq
        >>> api = openaq.OpenAQ()
            ...
            "results": [
                {
                    ...
                    "results": [
                        {
                            "message": "New measurements inserted for Mandir Marg: 
1",
                            "failures": {},
                            "count": 0,
                            "duration": 0.153,
                        ...
                        {
                            "message": "New measurements inserted for Sao Paulo: 
1898",
                            "failures": {},
                            "count": 1898,
                            "duration": 16.918,
    ...
    def parameters(self, **kwargs):
        ...
        :param order_by: order by one or more fields (ex. 
order_by=['preferredUnit', 'id']). Default value is 'country'
        :param sort: define the sort order for one or more fields (ex. sort='desc')
        :type order_by: string or list
        :type sort: string
...
diameter",
    ...
    def sources(self, **kwargs):
        ...
        :param order_by: order by one or more fields (ex. order_by=['active', 
'country']). Default value is 'country'
        :param sort: define the sort order for one or more fields (ex. sort='desc')
        ...
        :return: a dictionary containing the *url*, *adapter*, *name*, *city*,
            *country*, *description*, *resolution*, *sourceURL*, *contacts*, and 
*active*.
        :Example:
        >>> import openaq
        >>> api = openaq.OpenAQ()
        ...
        [
            {
                "url": 
"http://airquality.environment.nsw.gov.au/aquisnetnswphp/getPage.php?reportid=2",
                "adapter": "nsw",
                "name": "Australia - New South Wales",
                "city": "",
                "country": "AU",
                "description": "Measurements from the Office of Environment & 
Heritage of the New South Wales government.",
                "resolution": "1 hr",
                "sourceURL": 
